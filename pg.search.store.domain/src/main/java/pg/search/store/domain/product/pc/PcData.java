package pg.search.store.domain.product.pc;
...
/**
 * A DTO for the {@link pg.search.store.infrastructure.product.pc.PcEntity} entity
 */
@AllArgsConstructor
@Builder
@Getter
public class PcData implements Serializable {
    public static final ProductType productType = ProductType.PC;
    ...
    private final Map<String, Integer> backPanelConnectors;
    private final Map<String, Integer> frontPanelConnectors;
    private final Map<String, Integer> freeInternalPorts;
