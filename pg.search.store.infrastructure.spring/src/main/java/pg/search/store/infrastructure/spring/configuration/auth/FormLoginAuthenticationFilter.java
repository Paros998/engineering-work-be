...
import static pg.search.store.infrastructure.spring.configuration.auth.JwtExpire.ACCESS_TOKEN;
import static pg.search.store.infrastructure.spring.configuration.auth.JwtExpire.REFRESH_TOKEN;
