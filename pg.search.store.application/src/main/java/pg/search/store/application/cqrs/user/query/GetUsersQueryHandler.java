...
@Service
@AllArgsConstructor
public class GetUsersQueryHandler implements QueryHandler<GetUsersQuery, PageResponse<UserData>> {
    private final UserService userService;
    private final UserMapper userMapper;

    public PageResponse<UserData> handle(final GetUsersQuery query) {
